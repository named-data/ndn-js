...
var DEFAULT_EC_PUBLIC_KEY_DER = new Buffer([
...
var DEFAULT_EC_PRIVATE_KEY_DER = new Buffer([
...
var CredentialStorage = function CredentialStorage()
{
  ...
  var ecdsaKeyName = new Name("/testEcdsa/DSK-123");
  this.ecdsaCertName = ecdsaKeyName.getSubName(0, ecdsaKeyName.size() - 1).append
...
describe('TestDataMethods', function() {
  ...
  it('VerifyEcdsa', function() {
    // We create simple callbacks to count calls since we're not interested in
    //   the effect of the callbacks themselves.
    var failedCallCount = 0;
    var verifiedCallCount = 0;

    credentials.signData(freshData, credentials.ecdsaCertName);
